 ...
 *      DEFINES
 *********************/
#define COLOR_BUFF_SIZE (MY_DISP_HOR_RES * (MY_DISP_VER_RES / 3))
...
//    lv_disp_draw_buf_init(&draw_buf_dsc_1, buf_1, NULL, MY_DISP_HOR_RES * (MY_DISP_VER_RES / 4));   /*Initialize the display buffer*/
		...
		//使用外部RAM
		static lv_disp_draw_buf_t draw_buf_dsc_1;
		lv_color_t *buf_1 = mymalloc(SRAMEX, COLOR_BUFF_SIZE * sizeof(lv_color_t));
		lv_color_t *buf_2 = mymalloc(SRAMEX, COLOR_BUFF_SIZE * sizeof(lv_color_t));
		lv_disp_draw_buf_init(&draw_buf_dsc_1, buf_1, buf_2, COLOR_BUFF_SIZE);
